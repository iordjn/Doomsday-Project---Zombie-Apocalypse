...
/* Base – Jordin */
INSERT INTO Base (base_id, base_name, location_description, capacity, security_level, food_storage, water_storage)
VALUES
(1, 'Fort Hope', 'Reinforced school building on east ridge', 50, 'High', 200, 300),
(2, 'Redwood Outpost', 'Hidden cabin camp deep in the forest', 20, 'Medium', 120, 150),
(3, 'Downtown Bunker', 'Underground shelter beneath city hall', 35, 'High', 300, 500);
...
/* Food – Alex */
INSERT INTO Food (food_id, food_name, category, calories_per_unit, shelf_life_days)
VALUES
(1, 'Canned Beans', 'Canned', 350, 900),
(2, 'Protein Bar', 'Snack', 220, 365),
(3, 'Dried Rice', 'Dry Goods', 600, 720);




/* Water – Alex */
INSERT INTO Water (water_id, source_type, container_type, volume_liters, is_purified)
VALUES
(1, 'River', 'Jug', 10.5, 0),
(2, 'Filtered Well', 'Barrel', 50, 1),
(3, 'Rainwater', 'Bottle', 2.0, 1);
